...
class NeighborhoodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create neighborhood" do
    assert_difference("Neighborhood.count") do
      post neighborhoods_url, params: { neighborhood: { maxlat: @neighborhood.maxlat, maxlong: @neighborhood.maxlong, minlat: @neighborhood.minlat, minlong: @neighborhood.minlong, name: @neighborhood.name } }
    end
  ...
  test "should update neighborhood" do
    patch neighborhood_url(@neighborhood), params: { neighborhood: { maxlat: @neighborhood.maxlat, maxlong: @neighborhood.maxlong, minlat: @neighborhood.minlat, minlong: @neighborhood.minlong, name: @neighborhood.name } }
