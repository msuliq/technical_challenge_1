...
class FlatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flat" do
    assert_difference("Flat.count") do
      post flats_url, params: { flat: { latitude: @flat.latitude, longitude: @flat.longitude, name: @flat.name } }
    end
  ...
  test "should update flat" do
    patch flat_url(@flat), params: { flat: { latitude: @flat.latitude, longitude: @flat.longitude, name: @flat.name } }
